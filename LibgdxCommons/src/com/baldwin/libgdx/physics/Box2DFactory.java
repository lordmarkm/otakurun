 ...
 * @author brian
 * 
 *stolen from http://www.java2s.com/Open-Source/Android/Game/libgdx/com/dozingcatsoftware/bouncy/elements/Box2DFactory.java.htm
 */
...
public class Box2DFactory {
  ...
  public static Body createWall (World world, float xmin, float ymin, float xmax, float ymax, float angle) {
      System.out.println("Creating wall at " + xmin + "," + ymin + " to " + xmax + "," + ymax);
